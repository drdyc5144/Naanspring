    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500">Update product information</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2.5 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm sm:text-base ${
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2.5 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm sm:text-base ${
          ...
          <div className="space-y-4">
            <div>
              ...
              {/* ✅ Image upload with click handler */}
              <div
              ...
              >
                <FaImage className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-3" />
